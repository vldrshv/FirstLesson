...
// урок 2: Основные операторы
// ---------------------------------------
// -- задание 1
let basicOperators = BasicOperators()
basicOperators.isEven(num: 4)
basicOperators.isEven(num: 5)
// -- задание 2
basicOperators.isDividedWithoutRemainderBy(number: 12, divider: 3)
basicOperators.isDividedWithoutRemainderBy(number: 11, divider: 3)
// задание 3
var array = basicOperators.createGrowingArray(size: 10)
// задание 4
basicOperators.removeDividedBy(arr: array, dividers: 2, 3)
// задание 5
var fibArr = basicOperators.createFibArray(size: 10)
